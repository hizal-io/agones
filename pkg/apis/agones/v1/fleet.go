...
type FleetSpec struct {
	...
	// +optional
	AllocationOverflow *AllocationOverflow `json:"allocationOverflow,omitempty" protobuf:"bytes,5,opt,name=allocationOverflow"`
	// Deployment strategy
...
type FleetStatus struct {
	...
	// +optional
	Counters map[string]AggregatedCounterStatus `json:"counters,omitempty" protobuf:"bytes,6,rep,name=counters"`
	// (Alpha, CountsAndLists feature flag) Lists provides aggregated List capacityv and List values
	// for this Fleet.
	// +optional
	Lists map[string]AggregatedListStatus `json:"lists,omitempty" protobuf:"bytes,7,rep,name=lists"`
}
