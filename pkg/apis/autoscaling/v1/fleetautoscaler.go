...
type FleetAutoscalerPolicy struct {
	...
	// +optional
	Counter *CounterPolicy `json:"counter,omitempty" protobuf:"bytes,4,opt,name=counter"`
	// [Stage:Alpha]
	// [FeatureFlag:CountsAndLists]
	// List policy config params. Present only if FleetAutoscalerPolicyType = List.
	// +optional
	List *ListPolicy `json:"list,omitempty" protobuf:"bytes,5,opt,name=list"`
}
...
type CounterPolicy struct {
	...
	MaxCapacity int64 `json:"maxCapacity" protobuf:"varint,2,opt,name=maxCapacity"`
	...
	MinCapacity int64 `json:"minCapacity" protobuf:"varint,3,opt,name=minCapacity"`
	...
	BufferSize intstr.IntOrString `json:"bufferSize" protobuf:"bytes,4,opt,name=bufferSize"`
}
